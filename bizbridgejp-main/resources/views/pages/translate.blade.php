                                ...
                                <div class="service__inner text-center">
                                    ...
                                    <div class="service__content">
                                        ...
                                        <h4><a style="font-size: 1.3rem"
                                                href="{{ url('/interpretation') }}">通訳サービス・Interpretation</a></h4>
                                        {{-- <p>優秀な外国人材 の紹介</p> --}}
                                        <a href="{{ url('/interpretation') }}" class="read-more">詳細</a>
                                    </div>
                                </div>
                            </div>
                            <div class="pp-back" style="background-image: url(assets/images/project/01.jpg);">
                                <a href="{{ url('/interpretation') }}" class="lab-btn">詳細</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-6 col-12">
                            ...
                            <div class="pp-fornt">
                                <div class="service__inner text-center">
                                    ...
                                    <div class="service__content">
                                        {{-- <span>現地パートナー紹介</span> --}}
                                        <h4><a style="font-size: 1.3rem"
                                                href="{{ url('/translate_service') }}">翻訳サービス・Translation</a></h4>
                                        {{-- <p>弊社は、特定技能を有する外国人の採用サポートを採用準備から受入れまで、ワンストップでサポート致します</p> --}}
                                        <a href="{{ url('/translate_service') }}" class="read-more">詳細</a>
                                    </div>
                                </div>
                            </div>
                            <div class="pp-back" style="background-image: url(assets/images/project/02.jpg);">
                                <a href="{{ url('/translate_service') }}" class="lab-btn">詳細</a>
                            </div>
                        </div>
                    </div>
                </div>
