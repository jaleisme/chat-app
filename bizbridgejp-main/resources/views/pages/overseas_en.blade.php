                    ...
                    <div class="col-lg-6 col-sm-6 col-12">
                        <div class="service__item position-relative">
                            <div class="pp-fornt">
                                <div class="service__inner text-center">
                                    <div class="service__thumb">
                                        <a href="{{ url('/busines_matching_en') }}">
                                            <img src="assets/images/service/icon/bm.png" alt="service" />
                                        </a>
                                    </div>
                                    <div class="service__content">
                                        {{-- <span>financial</span> --}}
                                        <h4><a style="font-size: 1.3rem" href="{{ url('/busines_matching_en') }}">Business
                                                matching platform service</a></h4>
                                        {{-- <p>B to Bプラットフォーム運営</p> --}}
                                        <a href="{{ url('/busines_matching_en') }}" class="read-more">Read More</a>
                                    </div>
                                </div>
                            </div>
                            <div class="pp-back" style="background-image: url(assets/images/project/04.jpg);">
                                <a href="{{ url('/busines_matching_en') }}" class="lab-btn">Read More</a>
                            </div>
                        </div>
                    </div>
