                            ...
                            <div class="service__item">
                                <div class="service__inner">
                                    ...
                                    <div class="service__content">
                                        <p><strong>海外展開の前に現地の状況を把握し、展開の時期・方法等を判断する参考材料を調<br>
                                                査するサービスを提供いたします。</strong></p>
                                        <p><strong>対応項目</strong><strong>：</strong></p>
                                        <p><strong>‐</strong> <strong>現地の関連規制の調査　（輸入規制・販売規制等）</strong></p>
                                        <p><strong>‐現地の市場実態の調査　（現地の類似品及び競合品の実態等）</strong></p>
                                        <p><strong>‐現地視察のサポート　　（現地視察の案内）</strong></p>
                                    </div>
                                </div>
                            </div>
                        </div>
