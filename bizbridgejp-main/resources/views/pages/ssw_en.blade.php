    ...
    <div class="pageheader">
        <div class="container">
            <div class="pageheader__content">
                <h2>2 Service Recruitment support for foreigners</h2>
    ...
    <div class="service service__two padding-tb">
        <div class="container">
            <div class="section__header text-center">
                <h6>Recruitment support for foreigners</h6>
                            ...
                            <div class="pp-fornt">
                                <div class="service__inner text-center">
                                    ...
                                    <div class="service__content">
                                        {{-- <span>調査サービス</span> --}}
                                        <h4><a style="font-size: 1.3rem" href="{{ url('ssw_excellent') }}">
                                                Excellent foreign human resources </a></h4>
                                        {{-- <p>優秀な外国人材 の紹介</p> --}}
                                        <a href="ssw_excellent" class="read-more">Read More</a>
                                    </div>
                                </div>
                            </div>
                            <div class="pp-back" style="background-image: url(assets/images/project/01.jpg);">
                                <a href="{{ url('ssw_excellent') }}" class="lab-btn">Read More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-6 col-12">
                        <div class="service__item position-relative">
                            <div class="pp-fornt">
                                <div class="service__inner text-center">
                                    <div class="service__thumb">
                                        <a href="{{ url('ssw_intro_en') }}">
                                            <img src="assets/images/service/icon/ssw.png" alt="service" />
                                        </a>
                                    </div>
                                    <div class="service__content">
                                        {{-- <span>現地パートナー紹介</span> --}}
                                        <h4><a style="font-size: 1.3rem" href="{{ url('ssw_intro_en') }}">Specific skilled
                                                workers</a></h4>
                                        {{-- <p>弊社は、特定技能を有する外国人の採用サポートを採用準備から受入れまで、ワンストップでサポート致します</p> --}}
                                        <a href="{{ url('ssw_intro_en') }}" class="read-more">Read More</a>
                                    </div>
                                </div>
                            </div>
                            <div class="pp-back" style="background-image: url(assets/images/project/02.jpg);">
                                <a href="{{ url('ssw_intro_en') }}" class="lab-btn">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
