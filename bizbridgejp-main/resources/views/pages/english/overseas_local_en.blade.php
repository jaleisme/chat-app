    ...
    <div class="pageheader">
        <div class="container">
            <div class="pageheader__content">
                <h2>Introduction of local partners <br> (joint venture at the time of establishment of local company)</h2>
                            ...
                            <div class="service__item">
                                <div class="service__inner">
                                    ...
                                    <div class="service__content">
                                        <p>We provide services that match the customer's wishes from the introduction of
                                            local partner candidates from research to contract conclusion</p>
                                        <p>(1)&nbsp; Proposal of a long list of candidates (10 companies)</p>
                                        <p>(2)&nbsp;Meeting settings (online and onsite)</p>
                                        <p>(3)&nbsp;Credit check before conclusion of contract (additional charge)</p>
                                        <p>(4)&nbsp;Follow-up of legal check of contracts (introduction of affiliated law
                                            firms)
                                        </p>
                                    </div>
                                </div>
