                            ...
                            <div class="service__item">
                                <div class="service__inner">
                                    ...
                                    <div class="service__content">
                                        <p>Grasp the local situation before overseas expansion and investigate reference
                                            materials for determining the timing and method of deployment. We will provide
                                            you with your service.</p>
                                        <p>Correspondence items:</p>
                                        <p>-&nbsp;&nbsp;&nbsp; Investigation of relevant local regulations &nbsp;(import
                                            regulations, sales regulations, etc.)</p>
                                        <p>- Survey of local market conditions (actual situation of similar and competing
                                            products in the local area,<br>&nbsp;&nbsp; etc.)</p>
                                        <p>- Support for on-site visits &nbsp;(information on on-site visits)</p>
                                    </div>
                                </div>
                            </div>
                        </div>
