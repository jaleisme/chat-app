                            ...
                            <div class="service__item">
                                <div class="service__inner">
                                    ...
                                    <div class="service__content">
                                        <p><strong>In recent years, cross-border EC </strong> <strong>from Japan</strong>
                                            has
                                            become popular in <strong>China, Taiwan, South Korea,</strong> <strong>etc.
                                                We</strong> leverage <strong>our strengths in</strong> Southeast Asia,
                                            <strong>especially Indonesia,</strong> <strong>to support our customers'
                                                cross-border EC. </strong>
                                        </p>
                                        <p><strong>Currently,</strong> <strong>in</strong> <strong>the Indonesian</strong>
                                            <strong>environment,</strong> there are <strong>many</strong> risks
                                            <strong>when</strong> <strong>individuals</strong> <strong>import</strong>
                                            <strong>from Japan. Our service</strong> <strong>removes</strong> <strong>your
                                                risk</strong> <strong>and</strong> <strong>supports you in expanding
                                                sales</strong> <strong>locally. </strong>
                                        </p>
                                        </p>
                                        <img src="assets/images/service/single/local_sales_case.png" alt="rajibraj" />
                                        <p></p>
                                        <p><strong>《</strong><strong>Case</strong><strong>》</strong><strong> (1</strong>)
                                            <strong>Outsourcing</strong> <strong>sales to retail stores (physical stores) in
                                                Indonesia</strong>
                                        </p>
                                        <p><strong>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; (2) Support
                                                for
                                                opening
                                                stores and sales</strong> <strong>on EC sites</strong> <strong>in
                                                Indonesia</strong></p>
                                    </div>
                                </div>
                            </div>
