                            ...
                            <div class="pp-fornt">
                                <div class="service__inner text-center">
                                    <div class="service__thumb">
                                        <a href="{{ url('/survey_service') }}">
                                            <img src="assets/images/service/icon/survey.png" alt="service" />
                                        </a>
                                    </div>
                                    <div class="service__content">
                                        {{-- <span>調査サービス</span> --}}
                                        <h4><a style="font-size: 1.3rem" href="{{ url('/survey_service') }}">調査サービス</a></h4>
                                        {{-- <p>調査サービス</p> --}}
                                        <a href="{{ url('/survey_service') }}" class="read-more">詳細</a>
                                    </div>
                                </div>
                            </div>
                            <div class="pp-back" style="background-image: url(assets/images/project/01.jpg);">
                                <a href="{{ url('/survey_service') }}" class="lab-btn">詳細</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-6 col-12">
                        <div class="service__item position-relative">
                            <div class="pp-fornt">
                                <div class="service__inner text-center">
                                    <div class="service__thumb">
                                        <a href="{{ url('/local_partner') }}">
                                            <img src="assets/images/service/icon/local.png" alt="service" />
                                        </a>
                                    </div>
                                    <div class="service__content">
                                        {{-- <span>現地パートナー紹介</span> --}}
                                        <h4><a style="font-size: 1.3rem" href="{{ url('/local_partner') }}">現地パートナー紹介</a>
                                        </h4>
                                        {{-- <p>現地会社設立時の合弁先</p> --}}
                                        <a href="{{ url('/local_partner') }}" class="read-more">詳細</a>
                                    </div>
                                </div>
                            </div>
                            <div class="pp-back" style="background-image: url(assets/images/project/02.jpg);">
                                <a href="{{ url('/local_partner') }}" class="lab-btn">詳細</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-6 col-12">
                        <div class="service__item position-relative">
                            <div class="pp-fornt">
                                <div class="service__inner text-center">
                                    <div class="service__thumb">
                                        <a href="{{ url('/local_sales') }}">
                                            <img src="assets/images/service/icon/sales.png" alt="service" />
                                        </a>
                                    </div>
                                    <div class="service__content">
                                        {{-- <span>Financial</span> --}}
                                        <h4><a style="font-size: 1.3rem" href="{{ url('/local_sales') }}">現地販売支援サービス</a>
                                        </h4>
                                        {{-- <p>拡販のB To C　⇒　越境ECサービス</p> --}}
                                        <a href="{{ url('/local_sales') }}" class="read-more">詳細</a>
                                    </div>
                                </div>
                            </div>
                            <div class="pp-back" style="background-image: url(assets/images/project/03.jpg);">
                                <a href="{{ url('/local_sales') }}" class="lab-btn">詳細</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-6 col-12">
                                ...
                                <div class="service__inner text-center">
                                    ...
                                    <div class="service__content">
                                        ...
                                        <h4><a style="font-size: 1.3rem"
                                                href="{{ url('/busines_matching') }}">ビジネスマッチングプラットフォームサービス</a></h4>
                                        {{-- <p>B to Bプラットフォーム運営</p> --}}
                                        <a href="{{ url('/busines_matching') }}" class="read-more">詳細</a>
                                    </div>
                                </div>
                            </div>
                            <div class="pp-back" style="background-image: url(assets/images/project/04.jpg);">
                                <a href="{{ url('/busines_matching') }}" class="lab-btn">詳細</a>
                            </div>
                        </div>
                    </div>
