    ...
    <div class="pageheader">
        <div class="container">
            <div class="pageheader__content">
                <h2>Business matching platform service</h2>
                            ...
                            <div class="service__item">
                                <div class="service__inner">
                                    ...
                                    <div class="service__content">
                                        <p><strong>(Bizbridge:</strong><a
                                                href="https://bizbridge.id/"><strong>https://bizbridge.id/</strong></a><strong>)</strong>
                                        </p>
                                        <p><strong>〈</strong><strong>Examples of sales channel development
                                                support</strong><strong>〉</strong></p>
                                        <p>
                                            <img src="assets/images/service/single/bm1.svg" alt="rajibraj" />
                                        <p></p>
                                        <img src="assets/images/service/single/bm2.svg" alt="rajibraj" />
                                    </div>
                                </div>
                            </div>
                        </div>
